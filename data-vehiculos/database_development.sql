...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-07-2019 a las 16:08:40
...
--
-- Base de datos: `database_development`
--
...
INSERT INTO `chats` (`id`, `mensaje`, `createdAt`, `updatedAt`, `UsuarioId`) VALUES
(1, 'hola', '2019-04-28 21:51:24', '2019-04-28 21:51:24', 1),
(2, 'que tal van', '2019-04-28 21:51:28', '2019-04-28 21:51:28', 1),
(3, 'nuevo mensaje', '2019-05-21 20:33:26', '2019-05-21 20:33:26', NULL),
(4, 'nuevo mensaje', '2019-05-21 20:33:40', '2019-05-21 20:33:40', NULL),
(5, 'nuevo mensaje', '2019-05-21 20:33:50', '2019-05-21 20:33:50', NULL),
(6, 'nuevo mensaje', '2019-05-21 20:33:55', '2019-05-21 20:33:55', NULL),
(7, 'hola', '2019-05-22 19:31:38', '2019-05-22 19:31:38', 1);
...
--
-- Estructura de tabla para la tabla `imagenesperfils`
--

CREATE TABLE `imagenesperfils` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `imagenesperfils`
--

INSERT INTO `imagenesperfils` (`id`, `imageUrl`, `createdAt`, `updatedAt`, `UsuarioId`) VALUES
(1, '../../assets/usuarios/pruebaGRAPHQL@gmail.com/images/thumbnail_zfx7myn6O_iron_man.png', '2019-04-28 21:51:05', '2019-04-28 21:51:05', 1),
(2, 'https://lh3.googleusercontent.com/-9imWjY1F43I/AAAAAAAAAAI/AAAAAAAAB6U/IaQUWFbNmmo/s96-c/photo.jpg', '2019-04-28 21:51:57', '2019-04-28 21:51:57', 2);
...
INSERT INTO `usuarios` (`id`, `nombres`, `apellidos`, `correo`, `contrasena`, `imageUrl`, `createdAt`, `updatedAt`) VALUES
(1, 'GRAPHQL', 'prueba', 'pruebaGRAPHQL@gmail.com', '$2a$05$XCvSCn/2/OAMFrvLbr3bQ.KsKAgmth35qpz0j5hpZEOrwlbyaEK3a', '../../assets/usuarios/pruebaGRAPHQL@gmail.com/images/thumbnail_zfx7myn6O_iron_man.png', '2019-04-28 21:51:05', '2019-04-28 21:51:05'),
(2, 'cristian andres', 'salazar mafla', 'cristiancaxi@gmail.com', '$2a$05$yBnS1rgdEmXHqGldUPYkhe/ai6dM7cuz.xYbHvgqoXpDLOB9iVIK.', 'https://lh3.googleusercontent.com/-9imWjY1F43I/AAAAAAAAAAI/AAAAAAAAB6U/IaQUWFbNmmo/s96-c/photo.jpg', '2019-04-28 21:51:57', '2019-04-28 21:51:57');
...
--
-- Indices de la tabla `imagenesperfils`
--
ALTER TABLE `imagenesperfils`
  ADD PRIMARY KEY (`id`),
  ADD KEY `UsuarioId` (`UsuarioId`);
...
ALTER TABLE `rolesusuarios`
  ADD PRIMARY KEY (`RoleId`,`UsuarioId`),
  ADD KEY `UsuarioId` (`UsuarioId`);
...
--
-- AUTO_INCREMENT de la tabla `imagenesperfils`
--
ALTER TABLE `imagenesperfils`
...
--
ALTER TABLE `chats`
  ADD CONSTRAINT `chats_ibfk_1` FOREIGN KEY (`UsuarioId`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `imagenesperfils`
--
ALTER TABLE `imagenesperfils`
  ADD CONSTRAINT `imagenesperfils_ibfk_1` FOREIGN KEY (`UsuarioId`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `rolesusuarios`
--
ALTER TABLE `rolesusuarios`
  ADD CONSTRAINT `rolesusuarios_ibfk_1` FOREIGN KEY (`RoleId`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `rolesusuarios_ibfk_2` FOREIGN KEY (`UsuarioId`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
